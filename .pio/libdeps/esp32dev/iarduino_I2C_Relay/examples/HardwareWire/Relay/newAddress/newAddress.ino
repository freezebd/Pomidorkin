...
void setup(){                                                                                                  //
    ...
    if( relay.begin(&Wire) ){      Serial.print( "найден модуль с адресом 0x" );                               //   Инициируем работу с модулем, указав ссылку на объект для работы с шиной I2C на которой находится модуль (Wire, Wire1, Wire2 ...).
